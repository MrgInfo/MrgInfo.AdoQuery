...
CREATE LOGIN AdoQuery WITH PASSWORD = 'AdoQuery',
    CHECK_POLICY = OFF,
    DEFAULT_DATABASE = AdoQuery
GO

--- CREATE LOGIN RCINET\WAVEZONE FROM WINDOWS WITH
---     DEFAULT_DATABASE = AdoQuery
--- GO

USE AdoQuery

CREATE USER AdoQuery FOR LOGIN AdoQuery
